...
public class AutoIngestArea {
    ...
    private final InboxItemCreatedListener inboxItemCreatedListener;

    public AutoIngestArea(Path inboxDir, long pollingIntervalMilliseconds, InboxItemCreatedListener inboxItemCreatedListener) {
        this.inboxDir = inboxDir;
        this.pollingInterval = pollingIntervalMilliseconds;
        this.inboxItemCreatedListener = inboxItemCreatedListener;
        this.start();
    }
    ...
    private class EventHandler extends FileAlterationListenerAdaptor {
        ...
        public void onDirectoryCreate(File directory) {
            inboxItemCreatedListener.onInboxItemCreated(directory.toPath());
        }
    }
}
